  ...
  module V2
    class Import < BaseCommand
      def call
        ...
        #content_items.each { |content_item| content_item.save! }
    ...
    private
      ...
      def create_content_item(history_entry, index, content_id)
        ...
        puts history_entry.except("states").merge(
        ...
        ).create_content_item(save: false) do |content_item|
            update_content_item_state_information(content_item,
                                                  history_entry[:states])
        end
        content_item
      end
